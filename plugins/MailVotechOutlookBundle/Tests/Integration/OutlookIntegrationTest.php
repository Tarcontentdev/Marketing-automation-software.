...
namespace MailVotechPlugin\MailVotechOutlookBundle\Tests\Integration;

use MailVotech\PluginBundle\Tests\Integration\AbstractIntegrationTestCase;
use MailVotechPlugin\MailVotechOutlookBundle\Integration\OutlookIntegration;
...
final class OutlookIntegrationTest extends AbstractIntegrationTestCase
{
    ...
    {
        // set server globals
        // @see MailVotech\CoreBundle\Helper\UrlHelper::rel2abs
        ...
        $this->assertSame('@MailVotechOutlook/Integration/form.html.twig', $formNotes['template']);
    }
}
