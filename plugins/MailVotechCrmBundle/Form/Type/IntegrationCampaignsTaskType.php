...
namespace MailVotechPlugin\MailVotechCrmBundle\Form\Type;
...
final class IntegrationCampaignsTaskType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder->add(
            ...
            TextType::class,
            [
                'label'       => 'mailvotech.connectwise.activity.name',
        ...
        $builder->add(
            ...
            [
                ...
                'attr'              => ['class' => 'form-control'],
                'label'             => 'mailvotech.plugin.integration.campaigns.connectwise.activity.type',
                'required'          => false,
            ]
        );
        ...
        $builder->add(
            ...
            [
                ...
                'attr'              => ['class' => 'form-control'],
                'label'             => 'mailvotech.plugin.integration.campaigns.connectwise.members',
                'constraints'       => [
                    new Callback(
                        function ($validateMe, ExecutionContextInterface $context): void {
                            $data = $context->getRoot()->getData();
