...
use MailVotechPlugin\MailVotechCrmBundle\Api\VtigerApi;
...
class VtigerIntegration extends CrmAbstractIntegration
{
    ...
    {
        return [
            'url'       => 'mailvotech.vtiger.form.url',
            'username'  => 'mailvotech.vtiger.form.username',
            'accessKey' => 'mailvotech.vtiger.form.password',
        ];
    }
    ...
    public function getFormNotes($section)
    {
        if ('leadfield_match' == $section) {
            return ['mailvotech.vtiger.form.field_match_notes', 'info'];
        }
    ...
    public function appendToForm(&$builder, $data, $formArea): void
    {
        if ('features' == $formArea) {
            $builder->add(
                ...
                [
                    'choices' => [
                        'mailvotech.vtiger.object.contact' => 'contacts',
                        'mailvotech.vtiger.object.company' => 'company',
                    ],
                    'expanded'          => true,
                    'multiple'          => true,
                    'label'             => 'mailvotech.vtiger.form.objects_to_pull_from',
                    'label_attr'        => ['class' => ''],
                    'placeholder'       => false,
                    'required'          => false,
                ]
