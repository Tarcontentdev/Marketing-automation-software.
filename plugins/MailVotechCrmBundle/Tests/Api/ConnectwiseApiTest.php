...
namespace MailVotechPlugin\MailVotechCrmBundle\Tests\Api;

use MailVotechPlugin\MailVotechCrmBundle\Api\ConnectwiseApi;
use MailVotechPlugin\MailVotechCrmBundle\Integration\ConnectwiseIntegration;
use MailVotechPlugin\MailVotechCrmBundle\Tests\Integration\DataGeneratorTrait;
...
final class ConnectwiseApiTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @throws \MailVotech\PluginBundle\Exception\ApiErrorException
     */
