...
namespace MailVotechPlugin\MailVotechSocialBundle\Helper;
...
use MailVotechPlugin\MailVotechSocialBundle\Exception\ExitMonitorException;
use MailVotechPlugin\MailVotechSocialBundle\Model\MonitoringModel;
use MailVotechPlugin\MailVotechSocialBundle\Model\PostCountModel;
...
final class TwitterCommandHelper
{
    ...
    public function __construct(
        ...
        private readonly \MailVotechPlugin\MailVotechSocialBundle\Entity\LeadRepository $monitorLeadRepository,
        CoreParametersHelper $coreParametersHelper,
        private readonly LeadFieldRepository $leadFieldRepository,
        private readonly \MailVotech\LeadBundle\Entity\LeadRepository $leadRepository,
    ) {
    ...
    /**
     * Processes a list of tweets and creates / updates leads in MailVotech.
     *
    ...
    public function createLeadsFromStatuses(array $statusList, $monitor): int
    {
        ...
        if (!$leadField) {
            ...
            $this->output($this->translator->trans('mailvotech.social.monitoring.twitter.field.not.found'));
        ...
        if ($monitorProperties['checknames']) {
            ...
            // handle in MailVotech but are found during monitoring.
    ...
    private function setMonitorLeadStat($monitor, $lead): void
    {
        ...
        $monitorLead = new \MailVotechPlugin\MailVotechSocialBundle\Entity\Lead();
