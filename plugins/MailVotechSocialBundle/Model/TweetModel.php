...
use MailVotechPlugin\MailVotechSocialBundle\Entity\TweetRepository;
use MailVotechPlugin\MailVotechSocialBundle\Entity\TweetStat;
...
use MailVotechPlugin\MailVotechSocialBundle\Form\Type\TweetType;
...
final class TweetModel extends FormModel implements AjaxLookupModelInterface
{
    ...
    {
        return 'mailvotechSocial:tweets';
    }
}
