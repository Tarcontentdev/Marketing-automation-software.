...
namespace MailVotechPlugin\MailVotechFullContactBundle\Services;

use MailVotechPlugin\MailVotechFullContactBundle\Exception\NoCreditException;
use MailVotechPlugin\MailVotechFullContactBundle\Exception\NotImplementedException;
