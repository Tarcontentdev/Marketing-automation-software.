...
use MailVotechPlugin\MailVotechFullContactBundle\Form\Type\BatchLookupType;
use MailVotechPlugin\MailVotechFullContactBundle\Form\Type\LookupType;
...
final class FullContactController extends FormController
{
    ...
    public function lookupPersonAction(Request $request, LookupHelper $lookupHelper, $objectId = ''): JsonResponse|Response
    {
        ...
        if (!$this->security->hasEntityAccess(
            ...
            $this->addFlashMessage(
                $this->translator->trans('mailvotech.plugin.fullcontact.forbidden'),
                [],
                'error'
            );
        ...
        if ('GET' === $request->getMethod()) {
            ...
            return $this->delegateView(
                [
                    ...
                    'contentTemplate' => '@MailVotechFullContact/FullContact/lookup.html.twig',
                    'passthroughVars' => [
    ...
    public function batchLookupPersonAction(Request $request, LookupHelper $lookupHelper): JsonResponse|Response
    {
        ...
        if (0 === $count) {
            $this->addFlashMessage(
                $this->translator->trans('mailvotech.plugin.fullcontact.empty'),
                [],
                'error'
            );
        ...
        if ($count > 20) {
            $this->addFlashMessage(
                $this->translator->trans('mailvotech.plugin.fullcontact.toomany'),
                [],
                'error'
            );
        ...
        if ('GET' === $request->getMethod()) {
            ...
            return $this->delegateView(
                [
                    ...
                    'contentTemplate' => '@MailVotechFullContact/FullContact/batchLookup.html.twig',
                    'passthroughVars' => [
                        'activeLink'    => '#mailvotech_contact_index',
    ...
    public function lookupCompanyAction(Request $request, LookupHelper $lookupHelper, $objectId = ''): JsonResponse|Response
    {
        ...
        if ('GET' === $request->getMethod()) {
            ...
            if (!$website) {
                $this->addFlashMessage(
                    $this->translator->trans('mailvotech.plugin.fullcontact.compempty'),
                    [],
                    'error'
                );
    ...
    public function batchLookupCompanyAction(Request $request, LookupHelper $lookupHelper): JsonResponse|Response
    {
        ...
        if ($count > 20) {
            $this->addFlashMessage(
                $this->translator->trans('mailvotech.plugin.fullcontact.comptoomany'),
                [],
                'error'
            );
