...
namespace MailVotechPlugin\MailVotechFullContactBundle\Helper;
...
use MailVotechPlugin\MailVotechFullContactBundle\Services\FullContact_Company;
use MailVotechPlugin\MailVotechFullContactBundle\Services\FullContact_Person;
use Monolog\Logger;
