export default class BlocksMjml {
  ...
  addBlocks() {
    ...
    this.blockManager.add('mj-37-columns', {
      label: MailVotech.translate('grapesjsbuilder.components.names.twoColumnThirdSevens'),
      category: MailVotech.translate('grapesjsbuilder.categorySectionLabel'),
    ...
    this.blockManager.add('text-sect', {
      label: MailVotech.translate('grapesjsbuilder.components.names.textSectionBlkLabel'),
      category: MailVotech.translate('grapesjsbuilder.reusableDynamicContentBlockLabel'),
    ...
    this.blockManager.add('grid-items', {
      label: MailVotech.translate('grapesjsbuilder.components.names.gridItemsBlkLabel'),
      category: MailVotech.translate('grapesjsbuilder.reusableDynamicContentBlockLabel'),
    ...
    this.blockManager.add('list-items', {
      label: MailVotech.translate('grapesjsbuilder.components.names.listItemsBlkLabel'),
      category: MailVotech.translate('grapesjsbuilder.reusableDynamicContentBlockLabel'),
