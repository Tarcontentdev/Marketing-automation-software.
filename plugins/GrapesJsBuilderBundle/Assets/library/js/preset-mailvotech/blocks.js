...
export default (editor, opts = {}) => {
  ...
  if (typeof bm.get('mj-1-column') !== 'undefined') {
    bm.get('mj-1-column').set({
      label: MailVotech.translate('grapesjsbuilder.components.names.oneColumn'),
  ...
  if (typeof bm.get('mj-2-columns') !== 'undefined') {
    bm.get('mj-2-columns').set({
      label: MailVotech.translate('grapesjsbuilder.components.names.twoColumn'),
      category: MailVotech.translate('grapesjsbuilder.categorySectionLabel'),
    });
  }
  ...
  if (typeof bm.get('mj-3-columns') !== 'undefined') {
    bm.get('mj-3-columns').set({
      label: MailVotech.translate('grapesjsbuilder.components.names.threeColumn'),
      category: MailVotech.translate('grapesjsbuilder.categorySectionLabel'),
    });
  }
