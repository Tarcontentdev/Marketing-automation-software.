...
export default class ButtonClose {
  ...
  getCommand() {
    ...
    if (mode === ContentService.modePageHtml) {
      return 'mailvotech-editor-page-html-close';
    }
    if (mode === ContentService.modeEmailHtml) {
      return 'mailvotech-editor-email-html-close';
    }
    if (mode === ContentService.modeEmailMjml) {
      return 'mailvotech-editor-email-mjml-close';
    }
   ...
   */
  getCallback() {
    if (this.command === 'mailvotech-editor-page-html-close') {
      return ButtonCloseCommands.closeEditorPageHtml;
    }
    if (this.command === 'mailvotech-editor-email-html-close') {
      return ButtonCloseCommands.closeEditorEmailHtml;
    }
    if (this.command === 'mailvotech-editor-email-mjml-close') {
