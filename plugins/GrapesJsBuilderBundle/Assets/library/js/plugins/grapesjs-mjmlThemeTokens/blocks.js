export const createBlockPatcher = ({ editor, options, classNames }) => {
  ...
  const getTypographyCategory = () => ({
    label: MailVotech.translate('grapesjsbuilder.categoryTypographyLabel'),
    order: -0.5,
    open: false,
  });
  ...
  const getBlockDefinitions = () => [
    ...
    },
    {
      ...
      requiresTokens: false,
      getBlock: (mjClass) => ({
        label: MailVotech.translate('grapesjsbuilder.blocks.typography.h1'),
        category: getTypographyCategory(),
    ...
    },
    {
      ...
      requiresTokens: false,
      getBlock: (mjClass) => ({
        label: MailVotech.translate('grapesjsbuilder.blocks.typography.h2'),
        category: getTypographyCategory(),
        content: `<mj-text${getMjTextAttributes(mjClass, {
          'font-size': '28px',
          'font-weight': 'bold',
    ...
    },
    {
      ...
      requiresTokens: false,
      getBlock: (mjClass) => ({
        label: MailVotech.translate('grapesjsbuilder.blocks.typography.h3'),
        category: getTypographyCategory(),
        content: `<mj-text${getMjTextAttributes(mjClass, {
          'font-size': '24px',
          'font-weight': 'bold',
    ...
    },
    {
      ...
      requiresTokens: false,
      getBlock: (mjClass) => ({
        label: MailVotech.translate('grapesjsbuilder.blocks.typography.h4'),
        category: getTypographyCategory(),
        content: `<mj-text${getMjTextAttributes(mjClass, {
          'font-size': '20px',
          'font-weight': 'bold',
    ...
    },
    {
      ...
      requiresTokens: false,
      getBlock: (mjClass) => ({
        label: MailVotech.translate('grapesjsbuilder.blocks.typography.subtitle'),
        category: getTypographyCategory(),
        content: `<mj-text${getMjTextAttributes(mjClass, {
          'font-size': '18px',
          color: '#666666',
    ...
    },
    {
      ...
      getBlock: (mjClass) => ({
        label: MailVotech.translate('grapesjsbuilder.secondaryButtonBlockLabel'),
        category: MailVotech.translate('grapesjsbuilder.categoryBlockLabel'),
