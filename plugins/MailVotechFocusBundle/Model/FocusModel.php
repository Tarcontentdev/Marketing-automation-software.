...
namespace MailVotechPlugin\MailVotechFocusBundle\Model;
...
use MailVotechPlugin\MailVotechFocusBundle\Form\Type\FocusType;
...
class FocusModel extends FormModel implements GlobalSearchInterface
{
    public function __construct(
        protected \MailVotech\FormBundle\Model\FormModel $formModel,
    ...
    public function generateJavascript(Focus $focus, $isPreview = false): string
    {
        ...
        $javascript = $this->twig->render(
            '@MailVotechFocus/Builder/generate.js.twig',
            [
                'focus'    => $focus,
                'preview'  => $isPreview,
                'clickUrl' => $url,
    ...
    public function getContent(array $focus, $isPreview = false, $url = '#')
    {
        ...
        $content = $this->twig->render(
            '@MailVotechFocus/Builder/content.html.twig',
            [
                'focus'    => $focus,
                'preview'  => $isPreview,
                'htmlMode' => $htmlMode,
        ...
        $formContent        = ($form instanceof \MailVotech\FormBundle\Entity\Form) ? $this->twig->render(
            '@MailVotechFocus/Builder/form.html.twig',
            [
                'form'           => $form,
                'pages'          => $pages,
                'lastPage'       => $lastPage,
    ...
    public function addStat(Focus $focus, $type, $data = null, $lead = null): ?Stat
    {
        ...
        switch ($type) {
            ...
            case Stat::TYPE_CLICK:
                /** @var \MailVotech\PageBundle\Entity\Hit|Submission $data */
                $typeId = $data->getId();
                break;
    ...
    public function getStats(Focus $focus, $unit, \DateTime $dateFrom, \DateTime $dateTo, $dateFormat = null, $canViewOthers = true): array
    {
        ...
        $chart->setDataset($this->translator->trans('mailvotech.focus.graph.views'), $data);
        ...
        if ('notification' != $focus->getType()) {
            if ('link' == $focus->getType()) {
                ...
                $data = $query->loadAndBuildTimeData($q);
                $chart->setDataset($this->translator->trans('mailvotech.focus.graph.clicks'), $data);
            } else {
                ...
                $data = $query->loadAndBuildTimeData($q);
                $chart->setDataset($this->translator->trans('mailvotech.focus.graph.submissions'), $data);
            }
        }
    ...
    {
        $q->join('t', MAILVOTECH_TABLE_PREFIX.'focus', 'm', 'e.id = t.focus_id')
