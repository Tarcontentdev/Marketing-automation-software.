...
final class ContentType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder->add(
            ...
            TextType::class,
            [
                'label'      => 'mailvotech.focus.form.headline',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'        => 'form-control',
                    'onblur'       => 'MailVotech.focusUpdatePreview()',
        ...
        $builder->add(
            ...
            TextType::class,
            [
                'label'      => 'mailvotech.focus.form.tagline',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'        => 'form-control',
        ...
        $builder->add(
            ...
            TextType::class,
            [
                'label'      => 'mailvotech.focus.form.link_text',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'        => 'form-control',
                    'onblur'       => 'MailVotech.focusUpdatePreview()',
        ...
        $builder->add(
            ...
            TextType::class,
            [
                'label'      => 'mailvotech.focus.form.link_url',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'        => 'form-control',
                    'onblur'       => 'MailVotech.focusUpdatePreview()',
        ...
        $builder->add(
            ...
            [
                'label' => 'mailvotech.focus.form.link_new_window',
        ...
        $builder->add(
            ...
            [
                ...
                'label'            => 'mailvotech.focus.form.font',
                'label_attr'       => ['class' => 'control-label'],
                'attr'             => [
                    'class'        => 'form-control',
                    'onchange'     => 'MailVotech.focusUpdatePreview()',
        ...
        $builder->add(
            ...
            TextareaType::class,
            [
                'label'      => 'mailvotech.focus.form.custom.css',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'        => 'form-control',
                    'rows'         => 6,
                    'onchange'     => 'MailVotech.focusUpdatePreview()',
                    'tooltip'      => 'mailvotech.focus.form.custom.css.help',
                ],
                'required' => false,
            ]
        );
