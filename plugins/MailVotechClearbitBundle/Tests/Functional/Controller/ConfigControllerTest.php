...
namespace MailVotechPlugin\MailVotechClearbitBundle\Tests\Functional\Controller;
...
use MailVotechPlugin\MailVotechClearbitBundle\Integration\Support\ConfigSupport;
...
final class ConfigControllerTest extends MailVotechMysqlTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $plugin->setBundle('MailVotechClearbitBundle');
        ...
        $this->configRoute = self::getContainer()->get(RouterInterface::class)->generate('mailvotech_plugin_config', ['name' => 'Clearbit']);
    }
