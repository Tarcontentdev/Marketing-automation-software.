...
namespace MailVotechPlugin\MailVotechClearbitBundle\Tests\Unit\EventListener;
...
use MailVotechPlugin\MailVotechClearbitBundle\EventListener\ButtonSubscriber;
...
final class ButtonSubscriberTest extends TestCase
{
    ...
    public function testInjectViewButtonsDoesNothingWhenIntegrationNotFound(): void
    {
        ...
        $event = $this->makeEvent(ButtonHelper::LOCATION_BULK_ACTIONS, 'mailvotech_contact_index');
    ...
    public function testInjectViewButtonsAddsBulkActionButtonForCompanyRoute(): void
    {
        ...
        $event = $this->makeEvent(ButtonHelper::LOCATION_BULK_ACTIONS, 'mailvotech_company_index');
    ...
    public function testInjectViewButtonsAddsNothingForUnrelatedRoute(): void
    {
        ...
        $event = $this->makeEvent(ButtonHelper::LOCATION_BULK_ACTIONS, 'mailvotech_email_index');
