...
namespace MailVotechPlugin\MailVotechClearbitBundle\EventListener;
                ...
                [
                    'attr' => [
                        ...
                        'onclick'     => 'this.href=\''.
                            ...
                            '?\' + mQuery.param({\'clearbit_batch_lookup\':{\'ids\':JSON.parse(MailVotech.getCheckedListIds(false, true))}});return true;',
                        'data-header' => $this->translator->trans('mailvotech.plugin.clearbit.button.caption'),
                    ],
                    'btnText'   => $this->translator->trans('mailvotech.plugin.clearbit.button.caption'),
                ...
                $lookupContactButton = [
                    'attr' => [
                        ...
                        'data-header' => $this->translator->trans(
                            'mailvotech.plugin.clearbit.lookup.header',
                    ...
                    [
                        'attr' => [
                            ...
                            'onclick'     => 'this.href=\''.
                                ...
                                '?\' + mQuery.param({\'clearbit_batch_lookup\':{\'ids\':JSON.parse(MailVotech.getCheckedListIds(false, true))}});return true;',
                            'data-header' => $this->translator->trans(
                                'mailvotech.plugin.clearbit.button.caption'
                            ),
                        ],
                        'btnText'   => $this->translator->trans('mailvotech.plugin.clearbit.button.caption'),
                        'iconClass' => 'ri-search-line',
