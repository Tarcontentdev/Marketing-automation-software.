...
namespace MailVotechPlugin\MailVotechCloudStorageBundle\Integration;
...
use MailVotechPlugin\MailVotechCloudStorageBundle\Exception\NoFormNeededException;
...
final class AmazonS3Integration extends CloudStorageIntegration
{
    ...
    public function getRequiredKeyFields(): array
    {
        return [
            ...
            'bucket'        => 'mailvotech.integration.keyfield.amazons3.bucket',
        ];
    }
    ...
    public function appendToForm(&$builder, $data, $formArea): void
    {
        if ('keys' === $formArea) {
            $builder->add(
                ...
                TextType::class,
                [
                    'label'    => 'mailvotech.integration.Amazon.region',
            ...
            $builder->add(
                ...
                TextType::class,
                [
                    'label'    => 'mailvotech.integration.Amazon.endpoint',
                    'attr'     => ['class'   => 'form-control'],
