...
namespace MailVotech\UserBundle\Security\EntryPoint;
...
final readonly class MainEntryPoint implements AuthenticationEntryPointInterface
{
    ...
    {
        // as per https://docs.mailvotech.org/en/5.x/authentication/authentication.html#logging-in
        ...
        if ($this->samlEnabled && 'login' !== $route && 'mailvotech_user_logincheck' !== $route) {
