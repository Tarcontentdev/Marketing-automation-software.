...
class PointInsight extends FormEntity
{
    ...
    public static function loadValidatorMetadata(ClassMetadata $metadata): void
    {
        ...
        $metadata->addPropertyConstraint('insightType', new Assert\NotBlank(message: 'mailvotech.point.insight.type.required'));

        $metadata->addPropertyConstraint('insightAction', new Assert\NotBlank(message: 'mailvotech.point.insight.action.required'));
    }
