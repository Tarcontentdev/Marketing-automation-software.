...
final class MailVotechReportBuilder implements ReportBuilderInterface
{
    /**
     * @var array
     */
    public const OPERATORS = [
        'default' => [
            ...
            'gt'         => 'mailvotech.core.operator.greaterthan',
            'gte'        => 'mailvotech.core.operator.greaterthanequals',
            'lt'         => 'mailvotech.core.operator.lessthan',
            'lte'        => 'mailvotech.core.operator.lessthanequals',
            'neq'        => 'mailvotech.core.operator.notequals',
            'like'       => 'mailvotech.core.operator.islike',
            'notLike'    => 'mailvotech.core.operator.isnotlike',
            'empty'      => 'mailvotech.core.operator.isempty',
            'notEmpty'   => 'mailvotech.core.operator.isnotempty',
            'contains'   => 'mailvotech.core.operator.contains',
            'startsWith' => 'mailvotech.core.operator.starts.with',
            'endsWith'   => 'mailvotech.core.operator.ends.with',
        ],
        'bool' => [
            'eq'  => 'mailvotech.core.operator.equals',
            'neq' => 'mailvotech.core.operator.notequals',
    ...
    public function getTagCondition(array $filter): ?string
    {
        ...
        $tagSubQuery->select('DISTINCT lead_id')
            ->from(MAILVOTECH_TABLE_PREFIX.'lead_tags_xref', 'ltx');
    ...
    public function getDncCondition(array $filter): ?string
    {
        ...
        $dncSubQuery = $this->db->createQueryBuilder()
            ...
            ->from(MAILVOTECH_TABLE_PREFIX.'lead_donotcontact', 'ldnc')
