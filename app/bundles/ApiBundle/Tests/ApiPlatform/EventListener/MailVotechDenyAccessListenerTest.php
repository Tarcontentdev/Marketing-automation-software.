...
use MailVotech\ApiBundle\ApiPlatform\EventListener\MailVotechDenyAccessListener;
...
final class MailVotechDenyAccessListenerTest extends TestCase
{
    ...
    private MailVotechDenyAccessListener $mailvotechDenyAccessListener;
    ...
    protected function setUp(): void
    {
        ...
        $this->mailvotechDenyAccessListener = new MailVotechDenyAccessListener(
    ...
    public function testOnSecurityEntityAccessAllowed(): void
    {
        ...
        $this->corePermissionsMock
            ...
            ->willReturn(true);
        $this->mailvotechDenyAccessListener->onSecurity($this->requestEvent);
    }
