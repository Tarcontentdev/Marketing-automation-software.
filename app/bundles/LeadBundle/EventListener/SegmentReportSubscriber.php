...
final readonly class SegmentReportSubscriber implements EventSubscriberInterface
{
    ...
    public function onReportBuilder(ReportBuilderEvent $event): void
    {
        ...
        $segmentColumns = [
            'lll.manually_removed' => [
                'label' => 'mailvotech.lead.report.segment.manually_removed',
                'type'  => 'bool',
            ],
            'lll.manually_added' => [
                'label' => 'mailvotech.lead.report.segment.manually_added',
                'type'  => 'bool',
            ],
        ];
    ...
    public function onReportGenerate(ReportGeneratorEvent $event): void
    {
        ...
        $qb->from(MAILVOTECH_TABLE_PREFIX.'lead_lists_leads', 'lll')
            ->leftJoin('lll', MAILVOTECH_TABLE_PREFIX.'leads', 'l', 'l.id = lll.lead_id')
            ->leftJoin('lll', MAILVOTECH_TABLE_PREFIX.'lead_lists', 's', 's.id = lll.leadlist_id')
