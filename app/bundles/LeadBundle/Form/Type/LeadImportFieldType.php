    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        if ('lead' === $options['object']) {
            $builder->add(
                $builder->create(
                    ...
                    LeadListType::class,
                    [
                        'label'      => 'mailvotech.lead.lead.field.list',
                        'label_attr' => ['class' => 'control-label'],
                        'attr'       => [
                            'class' => 'form-control',
                        ],
        ...
        if (in_array($options['object'], ['lead', 'company'])) {
            $builder->add(
                ...
                [
                    'label'      => 'mailvotech.lead.import.skip_if_exists',
                    'label_attr' => ['class' => 'control-label'],
                    'attr'       => ['class' => 'form-control'],
                    'required'   => false,
                    'data'       => false,
        ...
        if (empty($options['line_count_limit'])) {
            $buttons = array_merge(
                $buttons,
                [
                    'apply_text'  => 'mailvotech.lead.import.in.background',
                    'apply_class' => 'btn btn-secondary',
                    'apply_icon'  => 'ri-history-line',
                    'save_text'   => 'mailvotech.lead.import.start',
            ...
            $buttons = array_merge(
                ...
                [
                    'apply_text' => false,
                    'save_text'  => 'mailvotech.lead.import',
