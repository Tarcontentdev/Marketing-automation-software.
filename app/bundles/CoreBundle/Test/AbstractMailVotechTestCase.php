...
abstract class AbstractMailVotechTestCase extends WebTestCase
{
     ...
     */
    public static function getMailerMessage(int $index = 0, ?string $transport = null): RawMessage|MailVotechMessage|null
    {
    ...
    {
        putenv('MAILVOTECH_CONFIG_PARAMETERS='.json_encode($defaultConfigOptions));
        EnvLoader::load();
    ...
    public function setCsrfHeader(string $intention = 'mailvotech_ajax_post'): void
    {
