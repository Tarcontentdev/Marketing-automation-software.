...
use MailVotech\InstallBundle\InstallFixtures\ORM\RoleData;
...
abstract class MailVotechMysqlTestCase extends AbstractMailVotechTestCase
{
    ...
    {
        return (string) static::getContainer()->getParameter('mailvotech.db_table_prefix');
    }
