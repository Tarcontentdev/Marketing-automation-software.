...
final class DateHelperTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->translator->method('trans')
            ->willReturnCallback(fn (string $key, array $parameters = []): string => match ($key) {
                'mailvotech.core.date.years.ago'   => $parameters['%count%'].' year(s) ago',
                'mailvotech.core.date.years.in'    => 'in '.$parameters['%count%'].' year(s)',
                'mailvotech.core.date.months.ago'  => $parameters['%count%'].' month(s) ago',
                'mailvotech.core.date.months.in'   => 'in '.$parameters['%count%'].' month(s)',
                'mailvotech.core.date.days.ago'    => $parameters['%count%'].' day(s) ago',
                'mailvotech.core.date.days.in'     => 'in '.$parameters['%count%'].' day(s)',
                'mailvotech.core.date.hours.ago'   => $parameters['%count%'].' hour(s) ago',
                'mailvotech.core.date.hours.in'    => 'in '.$parameters['%count%'].' hour(s)',
                'mailvotech.core.date.minutes.ago' => $parameters['%count%'].' minute(s) ago',
                'mailvotech.core.date.minutes.in'  => 'in '.$parameters['%count%'].' minute(s)',
                'mailvotech.core.date.just.now'    => 'just now',
                'mailvotech.core.date.today'       => 'Today',
                default                         => $key,
            });
    }
    ...
    public function testToTextWithConfigurationToTime(): void
    {
        ...
        $this->translator->expects($this->once())
            ->method('trans')
            ->with('mailvotech.core.date.today', $this->anything())
            ->willReturn('Today');
