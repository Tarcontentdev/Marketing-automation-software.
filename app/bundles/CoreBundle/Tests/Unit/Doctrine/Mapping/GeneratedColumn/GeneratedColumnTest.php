...
namespace MailVotech\CoreBundle\Tests\Unit\Doctrine\Mapping\GeneratedColumn;
...
final class GeneratedColumnTest extends \PHPUnit\Framework\TestCase
{
    public function testAllGettersAndSeters(): void
    {
        ...
        $expectedAlterQuery       = 'ALTER TABLE '.MAILVOTECH_TABLE_PREFIX."page_hits ADD generated_hit_date DATE AS (CONCAT(YEAR(date_hit), \"-\", LPAD(MONTH(date_hit), 2, \"0\"), \"-\", LPAD(DAY(date_hit), 2, \"0\"))) COMMENT '(DC2Type:generated)';
            ALTER TABLE ".MAILVOTECH_TABLE_PREFIX.'page_hits ADD INDEX `'.MAILVOTECH_TABLE_PREFIX.'generated_hit_date_page_id`(generated_hit_date, page_id)';
        ...
        $this->assertSame(MAILVOTECH_TABLE_PREFIX.'generated_hit_date_page_id', $generatedColumn->getIndexName());
