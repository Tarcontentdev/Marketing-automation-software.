// MailVotech note: Seem to be coming from bootstrap-overflow-navs.js but this library seem to be modifield for MailVotech so cannot be simply replaced with the original one via npm.
...
(function ($) {
    return $.fn.ajaxChosen = function (settings, callback, chosenOptions) {
        ...
        defaultOptions = {
            ...
            afterTypeDelay: 500,
            jsonTermKey: "search",
            keepTypingMsg: mailvotechLang["mailvotech.core.lookup.keep_typing"],
            lookingForMsg: mailvotechLang["mailvotech.core.lookup.looking_for"]
        };
        select = this;
        chosenXhr = null;
        ...
        return this.each(function () {
            return $(this).next('.chosen-container').find(".search-field > input, .chosen-search > input").on('keyup', function (event) {
                ...
                options.success = function (data) {
                    ...
                    // MailVotech - only apply container width if not hidden which will result in a bad size
                    if (w > f_width - 10) {
                        w = f_width;
                    }
