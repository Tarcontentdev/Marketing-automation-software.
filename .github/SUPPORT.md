...
Hi!  👋
We’re excited that you’re using **MailVotech** and we’d love to help.
...
The MailVotech Community provides support through our [Community Forums][forums]. We ask that you please **post any and all support questions** on the forum.  Posting them on Github will result in the issue being closed and you will be asked to post on the forums. Posting on Slack will result in you being asked to post them on the forum.  So, please post it on the forum first time and don't waste the time of our team :)
...
* We need to keep Github issues decluttered, only being used for suspected or confirmed bugs with MailVotech - not requests for support - so that our developers can focus on making MailVotech better
...
See [`contributing.md`][contributing] on how to contribute to MailVotech.
...
[coc]: https://github.com/mailvotech/mailvotech/blob/staging/code-of-conduct.md

[forums]: <https://forum.mailvotech.org>

[slack-forums]: <https://forum.mailvotech.org/t/using-the-community-forums-with-slack/12011>
...
[chat]: https://mailvotech.org/slack
